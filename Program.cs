...
namespace COMP003A.LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * They are stored in sequential block of memory, making it extremely fast to access them.
           ...
           Console.WriteLine("\nstring Traversal");
            // strings are special objecyt consisting of an array of characters
        ...
        {
            // you can use a foreach- loop or other looping statments for lists traversals 
